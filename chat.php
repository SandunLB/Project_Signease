    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        ...
        <div class="overflow-hidden relative shadow-md sm:rounded-lg">
            <div class="flex h-[calc(100vh-200px)]">
                <!-- Conversation List -->
                <div class="w-1/3 border-r dark:border-gray-700 bg-white dark:bg-gray-800">
                    ...
                    <?php if ($activeConversationId): ?>
                        ...
                        <div class="flex-1 overflow-y-auto p-4" id="chat-messages">
                            <?php foreach ($messages as $message): ?>
                                <div class="mb-4 <?= $message['sender_id'] == $_SESSION['user_id'] ? 'text-right' : 'text-left' ?>" id="message-<?= $message['id'] ?>">
                                    <div class="inline-block p-2 rounded-lg <?= $message['sender_id'] == $_SESSION['user_id'] ? 'bg-blue-500 text-white' : 'bg-gray-300 dark:bg-gray-600 text-gray-800 dark:text-white' ?> relative group">
                        ...
                        <div class="p-4 border-t dark:border-gray-700">
                            <form id="message-form" class="flex">
                                ...
                                <input type="text" name="message" placeholder="Type a message" class="flex-1 border rounded-l-lg p-2 dark:bg-gray-700 dark:text-white dark:border-gray-600" required>
...
<div class="fixed bottom-4 right-4">
    <button onclick="document.getElementById('newConversationModal').classList.remove('hidden')" class="bg-green-500 text-white rounded-full p-4 shadow-lg hover:bg-green-600">
        ...
        <div class="mt-3 text-center">
            ...
            <div class="mt-2 px-7 py-3">
                <form id="new-conversation-form">
                    <input type="hidden" name="action" value="send_message">
                    <input type="email" name="receiver_email" placeholder="Enter email address" class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-gray-600" required>
                    <input type="text" name="message" placeholder="Type a message" class="w-full px-3 py-2 border rounded-lg mt-2 dark:bg-gray-700 dark:text-white dark:border-gray-600" required>
                    <button type="submit" class="w-full mt-2 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">Start Chat</button>
                </form>
            </div>
