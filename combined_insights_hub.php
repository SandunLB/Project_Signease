...
$feedbacks = $isAdmin ? getFeedback() : null;
...
<body class="bg-gray-100 dark:bg-gray-900">
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            ...
            <div class="mb-4">
                <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400">
                    ...
                    <li class="mr-2">
                        <a href="#" class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:hover:text-gray-300" data-tab="<?php echo $isAdmin ? 'feedback-section' : 'submit-feedback-section'; ?>"><?php echo $isAdmin ? 'Feedback' : 'Submit Feedback'; ?></a>
                    </li>
                </ul>
            </div>
                            ...
                            <tbody>
                                <?php foreach ($feedbacks as $feedback): ?>
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition duration-300 ease-in-out">
                                        ...
                                        <td class="td class="py-4 px-6"><?php echo htmlspecialchars(substr($feedback['subject'], 0, 30)) . '...'; ?></td>
            ...
            <?php else: ?>
                <!-- User Submit Feedback Section -->
                <div id="submit-feedback-section" class="tab-content">
    ...
    <?php if ($isAdmin): ?>
        ...
        <!-- Feedback Details Modal for Admin -->
